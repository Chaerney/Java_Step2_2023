...
public class Member3 implements Comparator<Member3> { //implements Comparable -> compareTo
	...
	@Override
	public int hashCode() {
		//memberName.hashCode() : String이므로 10진수로 changer
	...
	public boolean equals(Object obj) {
		if(obj instanceof Member2) {
			Member2 member = (Member2)obj; //받아온
